...
void SV_SpawnServer( char *server, qboolean killBots ) {
	...
	// callvote map disabled by default
	sv.mapenable=qfalse;
	//callvote avotehasalreadypassed
	sv.avotehasalreadypassed=qfalse;
	//map_restart
	sv.map_restart=qfalse;
	//match_restart
	sv.match_restart=qfalse;
	// resets sv.nextmap
	Q_strncpyz(sv.nextmap, "", sizeof(sv.nextmap));
	//addbot allows
	sv.addbotallowed=qfalse;
...
void SV_Init (void)
{
	...
	#ifdef ELITEFORCE
	sv_master[1] = Cvar_Get ("sv_master2", "master.stef1.ravensoft.com:27953", CVAR_ARCHIVE );
	sv_master[2] = Cvar_Get ("sv_master3", "efmaster.tjps.eu", CVAR_ARCHIVE );
	#else
