...
typedef struct {
	...
	char 		nextmapvoteString[MAX_STRING_CHARS];
	char		nextmap[MAX_STRING_CHARS];
	char		nextmapname[MAX_STRING_CHARS];
	char		spectatorbanned[MAX_STRING_CHARS];
	...
	int			time;
	qboolean 	mapenable;
	char		arg1copy[MAX_STRING_CHARS];
	char		arg2copy[MAX_STRING_CHARS];
	char		arg3copy[MAX_STRING_CHARS];
	char		arg4copy[MAX_STRING_CHARS];
	char		arg5copy[MAX_STRING_CHARS];
	qboolean	avotehasalreadypassed;
	qboolean 	map_restart;
	qboolean	match_restart;
	qboolean 	addbotallowed;
	int			warmupcounter;
} server_t;
...
void SV_WriteClientSessionData( client_t *client );
void SV_ReadSessionData( client_t *client );
void SV_InitSessionData( client_t *client, char *userinfo );
void SV_WriteSessionData( void );
